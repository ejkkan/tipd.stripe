...
const pool = new Pool({
  connectionString:
    "postgres://yxubhcem:Df3zDgW8PFDD9CmiCCpLjrbyXL9UlFnf@balarama.db.elephantsql.com:5432/yxubhcem",
});
...
const createAd = async (req, res, next) => {
  ...
  try {
    ...
    const text = "INSERT INTO ads(title, description) VALUES($1) RETURNING *";
